...
def create_knowledge_graph(gen_answer, 
    ...
    #     print(idx, Event_graph[idx])
    # input()

    # for idx in Relation_graph:
    #     try:
    #         print(idx)
    #         print('text : ', Relation_graph[idx]['text'])
    #         print('Relation : ', Relation_graph[idx]['Relation 1'])
    #         print('Event1 : ', Relation_graph[idx]['Event1'])
    #         print('Event2 : ', Relation_graph[idx]['Event2'])
    #         input()
    #     except:
    #         input()
...
def check_high_overlap(tagging, tagging2):
    ...
    try:
        ...
        max_overlap = 2
    # print(tagging, '\n',  tagging2)
    # print(longest_common_subsequence(tag_dict['Event1'], tag_dict_2['Event1']), longest_common_subsequence(tag_dict['Event2'], tag_dict_2['Event2']))
    # print(longest_common_subsequence(tag_dict['Event1'], tag_dict_2['Event2']), longest_common_subsequence(tag_dict['Event2'], tag_dict_2['Event1']))
    # print(max_overlap)
    # input()
...
def generate_tagging(path_save_model, model_name, text, tokenizer, device):
    ...
    # tagging = [tokenizer.decode(tagging_id, skip_special_tokens=True) for tagging_id in tagging_ids]
...
def check_corf(subject, allennlp_pred, new_lines, idx):
    ...
    for entity_name in allennlp_pred['coreference']:
        # print(entity_name, allennlp_pred['coreference'][entity_name])
    ...
    # print('pronoun : ', pronoun, pronoun_idx)
    # input()
    ...
    # print(' '.join(allennlp_pred['document'][min(pronoun_idx, final_subject_idx):max(pronoun_idx, final_subject_idx)]))
    # print(corf_range)
    # input()
...
def connect_relation_graph(gen_answer, context, Relation_graph, tokenizer, device, target, model_name, Event_count):
    ...
    #         for idx2 in chain:
    #             print('Relation : ', Relation_graph[idx2]['Relation 1'])
    #             print('Event1 : ', Relation_graph[idx2]['Event1'])
    #             print('Event2 : ', Relation_graph[idx2]['Event2'])
    #         input()
...
if __name__ == '__main__':
    ...
    # # text = create_prompt(args.Model, generate_type = 'question', context = context)
